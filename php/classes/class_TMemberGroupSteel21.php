...
//      80    string  Тип стали (например, "C255" + остальные нулевые;
//                              Другая - все нулевые)
...
//                      
//      3     -       Нулевые байты
//      1     bool    Коэффициент расчетной длины отличается от нормативных 
//                                          (0 - да, 1 - нет)
...
//      1     bool    Проверка перемещений от временных нагрузок
//                                               (0 - да, 1 - нет)  
//      32     -      Нулевые байты
